...
print(mi_pajaro)
print(otro_pajaro) # Tienen diferentes lineas de memoria.
...
# Práctica Clases 3
# Crea una clase llamada PlataformaStreaming y crea los siguientes objetos a partir de ella: netflix, hbo_max,
# amazon_prime_video
