...
text = "Cuando algo es lo suficientemente importante, lo haces incluso si las probabilidades de que salga bien no" \
       " te acompañan"
...
mi_bool = palabra1 and palabra2 not in text
