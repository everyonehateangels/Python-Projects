...
# En el caso de este ejercicio, sin embargo,
# necesitaré que lo hagamos de una forma ligeramente distinta para que pueda ser evaluado:
...
# para que pueda ser evaluado: deberás implementarlo DENTRO de la función.
...
# deberá limitarse a imprimir el resultado del cociente (división) entre los dos números entregados como argumento.
...
# Hemos visto en la lección de qué manera se implementa el manejo de errores habitualmente en Python.
# En el caso de este ejercicio, sin embargo, necesitaré que lo hagamos de una forma ligeramente distinta para que pueda
# ser evaluado: deberás implementarlo DENTRO de la función. En forma de comentario, verás un ejemplo de resolución.
# Ten presente, sin embargo, que la forma preferida es la que hemos visto en clase.
#
